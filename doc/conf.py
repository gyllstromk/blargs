# -*- coding: utf-8 -*-
#
# blargs documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath(os.path.join('_themes', 'blargs')))
...
latex_documents = [
  ('index', 'blargs.tex', u'blargs Documentation',
...
man_pages = [
    ('index', 'blargs', u'blargs Documentation',
     [u'Karl Gyllstrom'], 1)
]
